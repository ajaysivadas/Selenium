...
public class TrelloMoving {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("user")).sendKeys("ajay.s2016@vitstudent.ac.in");
		explicitWait.until(ExpectedConditions.invisibilityOfElementLocated(By.id ("password")));
		driver.findElement(By.id("login")).click();
		driver.findElement(By.id("password")).sendKeys("trello@5101998");
		...
		// WebElement dstElement = driver.findElement (By.xpath("//h4[text()='Done']/../..//span[text()="));
